...
# Connected Toos 와 Function Call Schema and Example 프롬프트를 System 프롬프트로 합치기
- System 프롬프트 다음에 이어지는 Assistant context 인 Connected Toos 와 Function Call Schema and Example 프롬프트를 System 프롬프트로 이동
- 기존 System 프롬프트 하단에 추가
